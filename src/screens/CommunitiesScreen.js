...
import CommunityCard from '../../components/CommunityCard'; // This will now work correctly
...
export default function CommunitiesScreen(){
  ...
  // The improved openCommunity function for better UX
  const openCommunity = (c) => {
    ...
    Alert.alert(
      c.name,
      `You have selected the ${c.name} community. What would you like to do?`,
      [
        { text: 'Create Post', onPress: doPost },
